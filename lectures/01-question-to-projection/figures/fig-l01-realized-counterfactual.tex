...
% counterfactual switches off the t = 5 shock and keeps every disturbance.
% Blue brackets are realized minus counterfactual (1, 0.5, 0.25); grey arrows
% are the change since t = 4, which mixes the shock with everything else.
...
\node[text=nwOrange, font=\footnotesize, anchor=north west]
  at (axis cs:4.35,-1.8) {counterfactual $y^{c}_t$: the $t=5$ shock switched off};
