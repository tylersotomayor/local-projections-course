...
* The workbook is never shipped (D5, D35). Obtain it with data/raw/get_rz.do,
* the copy in each lab project that uses these data, or with its source,
* shared/stata/get_rz.do in the course repository. Either one downloads the
* package from the authors' link, verifies the hash, and prints manual steps
